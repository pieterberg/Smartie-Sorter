...
// White and black frequencies for the TCS3200 clour sensor
// -------------------------------------------------------------------------- //

    // White Frequency for the TCS3200 colour sensor
    const int redWhiteFrequency = 245;
    const int greenWhiteFrequency = 224;
    const int blueWhiteFrequency = 166;

    // Black Frequency for the TCS3200 colour sensor
